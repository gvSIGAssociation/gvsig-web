...
public class GestorCatalogoServiceImpl implements GestorCatalogoService {
    ...
    /*
     * (non-Javadoc)
     * @see es.gva.dgti.gvgeoportal.service.domain.GestorCatalogoService
     * #findAllGestorCatalogos(String, String)
     */
    public List<GestorCatalogo> findAllGestorCatalogos(String sortFieldName,
            String sortOrder) {
