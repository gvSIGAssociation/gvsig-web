...
public class ConfAyudaBuscadorServiceImpl implements ConfAyudaBuscadorService {
    ...
    /*
     * (non-Javadoc)
     * @see es.gva.dgti.gvgeoportal.service.domain.ConfAyudaBuscadorService#findConfAyudaBuscadorsByGeoPortal(es.gva.dgti.gvgeoportal.domain.GeoPortal)
     */
    public ConfAyudaBuscador findConfAyudaBuscadorsByGeoPortal(
            GeoPortal geoPortal) {

        ConfAyudaBuscador result = null;
        TypedQuery<ConfAyudaBuscador> confAyudaBuscadorResult = null;
        confAyudaBuscadorResult = ConfAyudaBuscador
                .findConfAyudaBuscadorsByGeoPortal(geoPortal);

        if (confAyudaBuscadorResult != null
                && confAyudaBuscadorResult.getResultList().size() > 0) {
