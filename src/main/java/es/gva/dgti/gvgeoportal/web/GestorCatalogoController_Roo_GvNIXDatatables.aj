...
import es.gva.dgti.gvgeoportal.web.GestorCatalogoController_Roo_Controller;
import es.gva.dgti.gvgeoportal.web.GestorCatalogoController_Roo_GvNIXDatatables;
...
privileged aspect GestorCatalogoController_Roo_GvNIXDatatables {
    
    declare precedence: GestorCatalogoController_Roo_GvNIXDatatables, GestorCatalogoController_Roo_Controller;
    
    @Autowired
    public ConversionService GestorCatalogoController.conversionService_dtt;
    
    @Autowired
    public MessageSource GestorCatalogoController.messageSource_dtt;
    
    public BeanWrapper GestorCatalogoController.beanWrapper_dtt;
    
    @Autowired
    private EntityManagerProvider GestorCatalogoController.entityManagerProvider_dtt;
    
    @Autowired
    public DatatablesUtilsBean GestorCatalogoController.datatablesUtilsBean_dtt;
    
    @Autowired
    public QuerydslUtilsBean GestorCatalogoController.querydslUtilsBean_dtt;
    
    @RequestMapping(method = RequestMethod.GET, produces = "text/html")
    public String GestorCatalogoController.listDatatables(Model uiModel, HttpServletRequest request) {
    ...
    @ModelAttribute
    public void GestorCatalogoController.populateDatatablesConfig(Model uiModel) {
    ...
    public Map<String, String> GestorCatalogoController.populateParametersMap(HttpServletRequest request) {
    ...
    public Map<String, Object> GestorCatalogoController.getPropertyMap(GestorCatalogo GestorCatalogo, Enumeration<Map<String, String>> propertyNames) {
    ...
    public Map<String, Object> GestorCatalogoController.getPropertyMap(GestorCatalogo GestorCatalogo, HttpServletRequest request) {
        // URL parameters are used as base search filters
        @SuppressWarnings("unchecked") Map<String, Object> propertyValuesMap = getPropertyMap(GestorCatalogo, request.getParameterNames());
    ...
    public void GestorCatalogoController.setDatatablesBaseFilter(Map<String, Object> propertyMap) {
        // Add here your baseFilters to propertyMap.
    }
    
    @ResponseBody
    @RequestMapping(headers = "Accept=application/json", params = "getColumnType")
    public String GestorCatalogoController.getColumnType(Model uiModel, HttpServletRequest request, @RequestParam(value = "_columnName_", required = false) String columnName) {
        // Getting all declared fields
        boolean fieldExists = false;
        Field attr = null;
        for(Field field : GestorCatalogo.class.getDeclaredFields()){
        ...
        if(!fieldExists){
            if(GestorCatalogo.class.getSuperclass() != null){
                for(Field field : GestorCatalogo.class.getSuperclass().getDeclaredFields()){
                    if(field.getName().equals(columnName)){
                        attr = field;
                        fieldExists = true;
                        break;
    ...
    public String GestorCatalogoController.geti18nText(Model uiModel, HttpServletRequest request, @RequestParam(value = "_locale_", required = false) String locale) {
    ...
    public String GestorCatalogoController.listDatatablesDetail(Model uiModel, HttpServletRequest request, @ModelAttribute GestorCatalogo gestorCatalogo) {
        ...
        return "forward:/WEB-INF/views/gestorcatalogos/list.jspx";
    }
    ...
    public String GestorCatalogoController.createDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid GestorCatalogo gestorcatalogo, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common create operations (check errors, populate, persist, ...)
        String view = create(gestorcatalogo, bindingResult, uiModel, httpServletRequest);
        ...
        redirectModel.addFlashAttribute(DatatablesUtilsBean.ROWS_ON_TOP_IDS_PARAM, gestorcatalogo.getId());
    ...
    public String GestorCatalogoController.updateDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid GestorCatalogo gestorcatalogo, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common update operations (check errors, populate, merge, ...)
        String view = update(gestorcatalogo, bindingResult, uiModel, httpServletRequest);
    ...
    public String GestorCatalogoController.deleteDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    @ResponseBody
    public DatatablesResponse<Map<String, String>> GestorCatalogoController.findAllGestorCatalogos(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request) {
        // URL parameters are used as base search filters
        Map<String, Object> baseSearchValuesMap = getPropertyMap(gestorCatalogo, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        SearchResults<GestorCatalogo> searchResult = datatablesUtilsBean_dtt.findByCriteria(GestorCatalogo.class, criterias, baseSearchValuesMap);
    ...
    @ResponseBody
    public ResponseEntity<String> GestorCatalogoController.checkFilterExpressions(WebRequest request, @RequestParam(value = "property", required = false) String property, @RequestParam(value = "expression", required = false) String expression) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        if(beanWrapper_dtt == null){
            beanWrapper_dtt = new BeanWrapperImpl(GestorCatalogo.class);
        }
    ...
    public void GestorCatalogoController.exportCsv(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, gestorCatalogo, ExportType.CSV, new CsvExport(), request, response);
    }
    
    @RequestMapping(value = "/exportpdf", produces = "text/pdf")
    public void GestorCatalogoController.exportPdf(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, gestorCatalogo, ExportType.PDF, new PdfExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxls", produces = "text/xls")
    public void GestorCatalogoController.exportXls(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, gestorCatalogo, ExportType.XLS, new XlsExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxlsx", produces = "text/xlsx")
    public void GestorCatalogoController.exportXlsx(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, gestorCatalogo, ExportType.XLSX, new XlsxExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxml", produces = "text/xml")
    public void GestorCatalogoController.exportXml(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute GestorCatalogo gestorCatalogo, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, gestorCatalogo, ExportType.XML, new XmlExport(), request, response);
    }
    
    public void GestorCatalogoController.export(DatatablesCriterias criterias, GestorCatalogo gestorCatalogo, ExportType exportType, DatatablesExport datatablesExport, HttpServletRequest request, HttpServletResponse response) throws ExportException {
        ...
        // 1. Retrieve the data
        List<Map<String, String>> data = retrieveData(criterias, gestorCatalogo, request);
        // 2. Build an instance of "ExportConf"
        ExportConf exportConf = new ExportConf.Builder(exportType).header(true).exportClass(datatablesExport).autoSize(true).fileName(gestorCatalogo.getClass().getSimpleName()).build();
    ...
    private List<Map<String, String>> GestorCatalogoController.retrieveData(DatatablesCriterias criterias, GestorCatalogo GestorCatalogo, HttpServletRequest request) {
        ...
        Map<String, Object> baseSearchValuesMap = getPropertyMap(GestorCatalogo, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        org.gvnix.web.datatables.query.SearchResults<es.gva.dgti.gvgeoportal.domain.GestorCatalogo> searchResult = datatablesUtilsBean_dtt.findByCriteria(GestorCatalogo.class, noPaginationCriteria, baseSearchValuesMap);
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        addDateTimeFormatPatterns(uiModel);
        Map<String, Object> datePattern = uiModel.asMap();
    ...
    @ResponseBody
    public List<Map<String, String>> GestorCatalogoController.createJsonForm(HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>();
        String controllerPath = "gestorcatalogos";
        ...
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(GestorCatalogo, "GestorCatalogo");
        bindingResult.initConversion(conversionService_dtt);
        request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "GestorCatalogo", bindingResult);
        
        populateItemForRender(request, GestorCatalogo, true);
    ...
    @ResponseBody
    public List<Map<String, String>> GestorCatalogoController.updateJsonForms(@RequestParam("id") Long[] ids, HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        if (ArrayUtils.isEmpty(ids)) {
            return new ArrayList<Map<String, String>>();
        }
        
        // Using PathBuilder, a cascading builder for Predicate expressions
        PathBuilder entity = new PathBuilder(GestorCatalogo.class, "entity");
        // URL parameters are used as base search filters
        Set set = new HashSet();
        set.addAll(Arrays.asList(ids));
        BooleanBuilder filterBy = querydslUtilsBean_dtt.createPredicateByIn(entity, "id", set);
        // Create a query with filter
        JPAQuery query = new JPAQuery(entityManagerProvider_dtt.getEntityManager(GestorCatalogo.class));
        query = query.from(entity);
        // execute query
        List<GestorCatalogo> gestorCatalogos = query.where(filterBy).list(entity);
        List<Map<String, String>> udpateForms = renderUpdateForm(gestorCatalogos, request, response);
        return udpateForms;
    }
    
    public List<Map<String, String>> GestorCatalogoController.renderUpdateForm(List<GestorCatalogo> gestorCatalogos, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>(gestorCatalogos.size());
        String controllerPath = "gestorcatalogos";
        ...
        for (GestorCatalogo GestorCatalogo : gestorCatalogos) {
            ...
            String render = buffer.toString();
            // Load item id
            item.put("DT_RowId", conversionService_dtt.convert(GestorCatalogo.getId(), String.class));
            // Put rendered content into first column
            item.put("form", render);
            result.add(item);
        }
    ...
    public void GestorCatalogoController.populateItemForRender(HttpServletRequest request, GestorCatalogo gestorCatalogo, boolean editing) {
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        
        request.setAttribute("gestorCatalogo", gestorCatalogo);
        request.setAttribute("itemId", conversionService_dtt.convert(gestorCatalogo.getId(),String.class));
        ...
        if (editing) {
            ...
            BeanPropertyBindingResult bindindResult = new BeanPropertyBindingResult(gestorCatalogo, "gestorCatalogo");
            bindindResult.initConversion(conversionService_dtt);
            request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "gestorCatalogo",bindindResult);
