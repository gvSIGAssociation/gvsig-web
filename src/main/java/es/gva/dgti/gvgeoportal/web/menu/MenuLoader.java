 ...
 * {@link Configurable}).
 * <p>
 * In application initialization ({@link WebApplicationObjectSupport}) loads the
 * menu structure and put it in the application context ready for rendering.
 * Then {@link ContextMenuStrategy} and security will decide which section and
...
public class MenuLoader extends WebApplicationObjectSupport {
    ...
    /**
     * Loads menu model from XML file {@link #MENU_CONFIG_FILE}. This method
     * loads menu using recursivity. Override this method to change menu's
     * source. Remember to set to <code>null</code> {@link #MENU_CONFIG_FILE}.
     * 
     * @return
     * @throws Exception
     */
     ...
     * @return List of MenuItem, note that MenuItem is complete, that is each
     *         MenuItem will contain their children List
     */
