...
import es.gva.dgti.gvgeoportal.web.ConfVistasPredefinidasController_Roo_Controller;
import es.gva.dgti.gvgeoportal.web.ConfVistasPredefinidasController_Roo_GvNIXDatatables;
...
privileged aspect ConfVistasPredefinidasController_Roo_GvNIXDatatables {
    
    declare precedence: ConfVistasPredefinidasController_Roo_GvNIXDatatables, ConfVistasPredefinidasController_Roo_Controller;
    
    @Autowired
    public ConversionService ConfVistasPredefinidasController.conversionService_dtt;
    
    @Autowired
    public MessageSource ConfVistasPredefinidasController.messageSource_dtt;
    
    public BeanWrapper ConfVistasPredefinidasController.beanWrapper_dtt;
    
    @Autowired
    private EntityManagerProvider ConfVistasPredefinidasController.entityManagerProvider_dtt;
    
    @Autowired
    public DatatablesUtilsBean ConfVistasPredefinidasController.datatablesUtilsBean_dtt;
    
    @Autowired
    public QuerydslUtilsBean ConfVistasPredefinidasController.querydslUtilsBean_dtt;
    
    @RequestMapping(method = RequestMethod.GET, produces = "text/html")
    public String ConfVistasPredefinidasController.listDatatables(Model uiModel, HttpServletRequest request) {
    ...
    @ModelAttribute
    public void ConfVistasPredefinidasController.populateDatatablesConfig(Model uiModel) {
    ...
    public Map<String, String> ConfVistasPredefinidasController.populateParametersMap(HttpServletRequest request) {
    ...
    public Map<String, Object> ConfVistasPredefinidasController.getPropertyMap(ConfVistasPredefinidas ConfVistasPredefinidas, Enumeration<Map<String, String>> propertyNames) {
    ...
    public Map<String, Object> ConfVistasPredefinidasController.getPropertyMap(ConfVistasPredefinidas ConfVistasPredefinidas, HttpServletRequest request) {
        // URL parameters are used as base search filters
        @SuppressWarnings("unchecked") Map<String, Object> propertyValuesMap = getPropertyMap(ConfVistasPredefinidas, request.getParameterNames());
    ...
    public void ConfVistasPredefinidasController.setDatatablesBaseFilter(Map<String, Object> propertyMap) {
        // Add here your baseFilters to propertyMap.
    }
    
    @ResponseBody
    @RequestMapping(headers = "Accept=application/json", params = "getColumnType")
    public String ConfVistasPredefinidasController.getColumnType(Model uiModel, HttpServletRequest request, @RequestParam(value = "_columnName_", required = false) String columnName) {
        // Getting all declared fields
        boolean fieldExists = false;
        Field attr = null;
        for(Field field : ConfVistasPredefinidas.class.getDeclaredFields()){
        ...
        if(!fieldExists){
            if(ConfVistasPredefinidas.class.getSuperclass() != null){
                for(Field field : ConfVistasPredefinidas.class.getSuperclass().getDeclaredFields()){
                    if(field.getName().equals(columnName)){
                        attr = field;
                        fieldExists = true;
                        break;
    ...
    public String ConfVistasPredefinidasController.geti18nText(Model uiModel, HttpServletRequest request, @RequestParam(value = "_locale_", required = false) String locale) {
    ...
    public String ConfVistasPredefinidasController.listDatatablesDetail(Model uiModel, HttpServletRequest request, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas) {
        ...
        return "forward:/WEB-INF/views/confvistaspredefinidases/list.jspx";
    }
    ...
    public String ConfVistasPredefinidasController.createDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid ConfVistasPredefinidas confvistaspredefinidas, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common create operations (check errors, populate, persist, ...)
        String view = create(confvistaspredefinidas, bindingResult, uiModel, httpServletRequest);
        ...
        redirectModel.addFlashAttribute(DatatablesUtilsBean.ROWS_ON_TOP_IDS_PARAM, confvistaspredefinidas.getId());
    ...
    public String ConfVistasPredefinidasController.updateDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid ConfVistasPredefinidas confvistaspredefinidas, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common update operations (check errors, populate, merge, ...)
        String view = update(confvistaspredefinidas, bindingResult, uiModel, httpServletRequest);
    ...
    public String ConfVistasPredefinidasController.deleteDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    @ResponseBody
    public DatatablesResponse<Map<String, String>> ConfVistasPredefinidasController.findAllConfVistasPredefinidases(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request) {
        // URL parameters are used as base search filters
        Map<String, Object> baseSearchValuesMap = getPropertyMap(confVistasPredefinidas, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        SearchResults<ConfVistasPredefinidas> searchResult = datatablesUtilsBean_dtt.findByCriteria(ConfVistasPredefinidas.class, criterias, baseSearchValuesMap);
    ...
    @ResponseBody
    public ResponseEntity<String> ConfVistasPredefinidasController.checkFilterExpressions(WebRequest request, @RequestParam(value = "property", required = false) String property, @RequestParam(value = "expression", required = false) String expression) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        if(beanWrapper_dtt == null){
            beanWrapper_dtt = new BeanWrapperImpl(ConfVistasPredefinidas.class);
        }
    ...
    public void ConfVistasPredefinidasController.exportCsv(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confVistasPredefinidas, ExportType.CSV, new CsvExport(), request, response);
    }
    
    @RequestMapping(value = "/exportpdf", produces = "text/pdf")
    public void ConfVistasPredefinidasController.exportPdf(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confVistasPredefinidas, ExportType.PDF, new PdfExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxls", produces = "text/xls")
    public void ConfVistasPredefinidasController.exportXls(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confVistasPredefinidas, ExportType.XLS, new XlsExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxlsx", produces = "text/xlsx")
    public void ConfVistasPredefinidasController.exportXlsx(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confVistasPredefinidas, ExportType.XLSX, new XlsxExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxml", produces = "text/xml")
    public void ConfVistasPredefinidasController.exportXml(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfVistasPredefinidas confVistasPredefinidas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confVistasPredefinidas, ExportType.XML, new XmlExport(), request, response);
    }
    
    public void ConfVistasPredefinidasController.export(DatatablesCriterias criterias, ConfVistasPredefinidas confVistasPredefinidas, ExportType exportType, DatatablesExport datatablesExport, HttpServletRequest request, HttpServletResponse response) throws ExportException {
        ...
        // 1. Retrieve the data
        List<Map<String, String>> data = retrieveData(criterias, confVistasPredefinidas, request);
        // 2. Build an instance of "ExportConf"
        ExportConf exportConf = new ExportConf.Builder(exportType).header(true).exportClass(datatablesExport).autoSize(true).fileName(confVistasPredefinidas.getClass().getSimpleName()).build();
    ...
    private List<Map<String, String>> ConfVistasPredefinidasController.retrieveData(DatatablesCriterias criterias, ConfVistasPredefinidas ConfVistasPredefinidas, HttpServletRequest request) {
        ...
        Map<String, Object> baseSearchValuesMap = getPropertyMap(ConfVistasPredefinidas, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        org.gvnix.web.datatables.query.SearchResults<es.gva.dgti.gvgeoportal.domain.components.ConfVistasPredefinidas> searchResult = datatablesUtilsBean_dtt.findByCriteria(ConfVistasPredefinidas.class, noPaginationCriteria, baseSearchValuesMap);
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        addDateTimeFormatPatterns(uiModel);
        Map<String, Object> datePattern = uiModel.asMap();
    ...
    @ResponseBody
    public List<Map<String, String>> ConfVistasPredefinidasController.createJsonForm(HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>();
        String controllerPath = "confvistaspredefinidases";
        ...
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(ConfVistasPredefinidas, "ConfVistasPredefinidas");
        bindingResult.initConversion(conversionService_dtt);
        request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "ConfVistasPredefinidas", bindingResult);
        
        populateItemForRender(request, ConfVistasPredefinidas, true);
    ...
    @ResponseBody
    public List<Map<String, String>> ConfVistasPredefinidasController.updateJsonForms(@RequestParam("id") Long[] ids, HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        if (ArrayUtils.isEmpty(ids)) {
            return new ArrayList<Map<String, String>>();
        }
        
        // Using PathBuilder, a cascading builder for Predicate expressions
        PathBuilder entity = new PathBuilder(ConfVistasPredefinidas.class, "entity");
        // URL parameters are used as base search filters
        Set set = new HashSet();
        set.addAll(Arrays.asList(ids));
        BooleanBuilder filterBy = querydslUtilsBean_dtt.createPredicateByIn(entity, "id", set);
        // Create a query with filter
        JPAQuery query = new JPAQuery(entityManagerProvider_dtt.getEntityManager(ConfVistasPredefinidas.class));
        query = query.from(entity);
        // execute query
        List<ConfVistasPredefinidas> confVistasPredefinidases = query.where(filterBy).list(entity);
        List<Map<String, String>> udpateForms = renderUpdateForm(confVistasPredefinidases, request, response);
        return udpateForms;
    }
    
    public List<Map<String, String>> ConfVistasPredefinidasController.renderUpdateForm(List<ConfVistasPredefinidas> confVistasPredefinidases, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>(confVistasPredefinidases.size());
        String controllerPath = "confvistaspredefinidases";
        ...
        for (ConfVistasPredefinidas ConfVistasPredefinidas : confVistasPredefinidases) {
            ...
            String render = buffer.toString();
            // Load item id
            item.put("DT_RowId", conversionService_dtt.convert(ConfVistasPredefinidas.getId(), String.class));
            // Put rendered content into first column
            item.put("form", render);
            result.add(item);
        }
    ...
    public void ConfVistasPredefinidasController.populateItemForRender(HttpServletRequest request, ConfVistasPredefinidas confVistasPredefinidas, boolean editing) {
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        
        request.setAttribute("confVistasPredefinidas", confVistasPredefinidas);
        request.setAttribute("itemId", conversionService_dtt.convert(confVistasPredefinidas.getId(),String.class));
        ...
        if (editing) {
            ...
            BeanPropertyBindingResult bindindResult = new BeanPropertyBindingResult(confVistasPredefinidas, "confVistasPredefinidas");
            bindindResult.initConversion(conversionService_dtt);
            request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "confVistasPredefinidas",bindindResult);
