...
privileged aspect ConfCapasTematicasController_Roo_GvNIXLoupeController {
    
    @Autowired
    public ConversionService ConfCapasTematicasController.conversionService_loupe;
    
    @Autowired
    public EntityManagerProvider ConfCapasTematicasController.entityManagerProvider_loupe;
    
    @RequestMapping(params = "selector", produces = "text/html")
    public String ConfCapasTematicasController.showOnlyList(Model uiModel, HttpServletRequest request, @RequestParam("path") String listPath) {
    ...
    public ResponseEntity<List<Map<String, String>>> ConfCapasTematicasController.findUsingAjax(WebRequest request, @RequestParam(value = "_search_", required = false) String search, @RequestParam(value = "_id_", required = false) String id, @RequestParam("_pkField_") String pkField, @RequestParam(value = "_max_", required = false, defaultValue = "3") Integer maxResult, @RequestParam(value = "_caption_", required = false) String caption, @RequestParam(value = "_additionalFields_", required = false) String additionalFields, @RequestParam("_field_") String field) {
        ...
        // Getting Entity
        BeanWrapper confcapastematicasBean = new BeanWrapperImpl(ConfCapasTematicas.class);
        // Getting field
        Class targetEntity = confcapastematicasBean.getPropertyType(field);
