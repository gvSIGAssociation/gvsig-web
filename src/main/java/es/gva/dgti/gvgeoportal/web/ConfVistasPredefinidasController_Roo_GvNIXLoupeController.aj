...
privileged aspect ConfVistasPredefinidasController_Roo_GvNIXLoupeController {
    
    @Autowired
    public ConversionService ConfVistasPredefinidasController.conversionService_loupe;
    
    @Autowired
    public EntityManagerProvider ConfVistasPredefinidasController.entityManagerProvider_loupe;
    
    @RequestMapping(params = "selector", produces = "text/html")
    public String ConfVistasPredefinidasController.showOnlyList(Model uiModel, HttpServletRequest request, @RequestParam("path") String listPath) {
        ...
        if (StringUtils.isNotBlank(parentId)) {
            ...
            uiModel.addAttribute("parentId", "ConfVistasPredefinidas_selector");
        }
    ...
    public ResponseEntity<List<Map<String, String>>> ConfVistasPredefinidasController.findUsingAjax(WebRequest request, @RequestParam(value = "_search_", required = false) String search, @RequestParam(value = "_id_", required = false) String id, @RequestParam("_pkField_") String pkField, @RequestParam(value = "_max_", required = false, defaultValue = "3") Integer maxResult, @RequestParam(value = "_caption_", required = false) String caption, @RequestParam(value = "_additionalFields_", required = false) String additionalFields, @RequestParam("_field_") String field) {
        ...
        // Getting Entity
        BeanWrapper confvistaspredefinidasBean = new BeanWrapperImpl(ConfVistasPredefinidas.class);
        // Getting field
        Class targetEntity = confvistaspredefinidasBean.getPropertyType(field);
