...
privileged aspect ConfCapasTematicasController_Roo_GvNIXDatatables {
    
    declare precedence: ConfCapasTematicasController_Roo_GvNIXDatatables, ConfCapasTematicasController_Roo_Controller;
    
    @Autowired
    public ConversionService ConfCapasTematicasController.conversionService_dtt;
    
    @Autowired
    public MessageSource ConfCapasTematicasController.messageSource_dtt;
    
    public BeanWrapper ConfCapasTematicasController.beanWrapper_dtt;
    
    @Autowired
    private EntityManagerProvider ConfCapasTematicasController.entityManagerProvider_dtt;
    
    @Autowired
    public DatatablesUtilsBean ConfCapasTematicasController.datatablesUtilsBean_dtt;
    
    @Autowired
    public QuerydslUtilsBean ConfCapasTematicasController.querydslUtilsBean_dtt;
    ...
    public Map<String, String> ConfCapasTematicasController.populateParametersMap(HttpServletRequest request) {
    ...
    public Map<String, Object> ConfCapasTematicasController.getPropertyMap(ConfCapasTematicas ConfCapasTematicas, Enumeration<Map<String, String>> propertyNames) {
        Map<String, Object> propertyValuesMap = new HashMap<String, Object>();
        
        // If no entity or properties given, return empty Map
        if(ConfCapasTematicas == null || propertyNames == null) {
        ...
        BeanWrapper entityBean = new BeanWrapperImpl(ConfCapasTematicas);
    ...
    public Map<String, Object> ConfCapasTematicasController.getPropertyMap(ConfCapasTematicas ConfCapasTematicas, HttpServletRequest request) {
        // URL parameters are used as base search filters
        @SuppressWarnings("unchecked") Map<String, Object> propertyValuesMap = getPropertyMap(ConfCapasTematicas, request.getParameterNames());
    ...
    public void ConfCapasTematicasController.setDatatablesBaseFilter(Map<String, Object> propertyMap) {
        // Add here your baseFilters to propertyMap.
    }
    
    @ResponseBody
    @RequestMapping(headers = "Accept=application/json", params = "getColumnType")
    public String ConfCapasTematicasController.getColumnType(Model uiModel, HttpServletRequest request, @RequestParam(value = "_columnName_", required = false) String columnName) {
        // Getting all declared fields
        boolean fieldExists = false;
        Field attr = null;
        for(Field field : ConfCapasTematicas.class.getDeclaredFields()){
        ...
        if(!fieldExists){
            if(ConfCapasTematicas.class.getSuperclass() != null){
                for(Field field : ConfCapasTematicas.class.getSuperclass().getDeclaredFields()){
                    if(field.getName().equals(columnName)){
                        attr = field;
                        fieldExists = true;
                        break;
    ...
    public String ConfCapasTematicasController.geti18nText(Model uiModel, HttpServletRequest request, @RequestParam(value = "_locale_", required = false) String locale) {
    ...
    public String ConfCapasTematicasController.listDatatablesDetail(Model uiModel, HttpServletRequest request, @ModelAttribute ConfCapasTematicas confCapasTematicas) {
        ...
        return "forward:/WEB-INF/views/confcapastematicases/list.jspx";
    }
    ...
    public String ConfCapasTematicasController.createDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid ConfCapasTematicas confcapastematicas, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common create operations (check errors, populate, persist, ...)
        String view = create(confcapastematicas, bindingResult, uiModel, httpServletRequest);
        ...
        redirectModel.addFlashAttribute(DatatablesUtilsBean.ROWS_ON_TOP_IDS_PARAM, confcapastematicas.getId());
    ...
    public String ConfCapasTematicasController.updateDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid ConfCapasTematicas confcapastematicas, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common update operations (check errors, populate, merge, ...)
        String view = update(confcapastematicas, bindingResult, uiModel, httpServletRequest);
    ...
    public String ConfCapasTematicasController.deleteDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    @ResponseBody
    public DatatablesResponse<Map<String, String>> ConfCapasTematicasController.findAllConfCapasTematicases(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request) {
        // URL parameters are used as base search filters
        Map<String, Object> baseSearchValuesMap = getPropertyMap(confCapasTematicas, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        SearchResults<ConfCapasTematicas> searchResult = datatablesUtilsBean_dtt.findByCriteria(ConfCapasTematicas.class, criterias, baseSearchValuesMap);
    ...
    @ResponseBody
    public ResponseEntity<String> ConfCapasTematicasController.checkFilterExpressions(WebRequest request, @RequestParam(value = "property", required = false) String property, @RequestParam(value = "expression", required = false) String expression) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        if(beanWrapper_dtt == null){
            beanWrapper_dtt = new BeanWrapperImpl(ConfCapasTematicas.class);
        }
    ...
    public void ConfCapasTematicasController.exportCsv(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confCapasTematicas, ExportType.CSV, new CsvExport(), request, response);
    }
    
    @RequestMapping(value = "/exportpdf", produces = "text/pdf")
    public void ConfCapasTematicasController.exportPdf(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confCapasTematicas, ExportType.PDF, new PdfExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxls", produces = "text/xls")
    public void ConfCapasTematicasController.exportXls(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confCapasTematicas, ExportType.XLS, new XlsExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxlsx", produces = "text/xlsx")
    public void ConfCapasTematicasController.exportXlsx(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confCapasTematicas, ExportType.XLSX, new XlsxExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxml", produces = "text/xml")
    public void ConfCapasTematicasController.exportXml(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute ConfCapasTematicas confCapasTematicas, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, confCapasTematicas, ExportType.XML, new XmlExport(), request, response);
    }
    
    public void ConfCapasTematicasController.export(DatatablesCriterias criterias, ConfCapasTematicas confCapasTematicas, ExportType exportType, DatatablesExport datatablesExport, HttpServletRequest request, HttpServletResponse response) throws ExportException {
        ...
        // 1. Retrieve the data
        List<Map<String, String>> data = retrieveData(criterias, confCapasTematicas, request);
        // 2. Build an instance of "ExportConf"
        ExportConf exportConf = new ExportConf.Builder(exportType).header(true).exportClass(datatablesExport).autoSize(true).fileName(confCapasTematicas.getClass().getSimpleName()).build();
    ...
    private List<Map<String, String>> ConfCapasTematicasController.retrieveData(DatatablesCriterias criterias, ConfCapasTematicas ConfCapasTematicas, HttpServletRequest request) {
        ...
        Map<String, Object> baseSearchValuesMap = getPropertyMap(ConfCapasTematicas, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        org.gvnix.web.datatables.query.SearchResults<es.gva.dgti.gvgeoportal.domain.components.ConfCapasTematicas> searchResult = datatablesUtilsBean_dtt.findByCriteria(ConfCapasTematicas.class, noPaginationCriteria, baseSearchValuesMap);
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        addDateTimeFormatPatterns(uiModel);
        Map<String, Object> datePattern = uiModel.asMap();
