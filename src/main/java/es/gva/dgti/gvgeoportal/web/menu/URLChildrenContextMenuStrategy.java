 ...
 * <p>
 * This strategy decides which menu item (root, subcategory, etc) should act as
 * root by matching current request URL with all menu entries target URLs.
 * <p>
 * If a match item is found (
 * {@link #query(HttpServletRequest, ServletContext, Menu)}) the menu will
 * render the children of the match menu entry.
 */
...
public class URLChildrenContextMenuStrategy extends BaseURLContextMenuStrategy {
     ...
     * return {@link MenuItem}'s children.
     * <p>
